...
TukuiMinimap:Point("TOPRIGHT", UIParent, "TOPRIGHT", -3, -3)
TukuiMinimap:Size(144)
TukuiMinimap:SetClampedToScreen(true)
TukuiMinimap:SetMovable(true)
TukuiMinimap.text = T.SetFontString(TukuiMinimap, C.media.pfont, 12, "MONOCHROMEOUTLINE")
...
m_zone_text:SetFont(C["media"].pfont, 12, "MONOCHROMEOUTLINE")
...
m_coord_text:SetFont(C["media"].pfont, 12, "MONOCHROMEOUTLINE")
