...
TukuiMinimap.text = T.SetFontString(TukuiMinimap, C.media.pfont, 8, "MONOCHROMEOUTLINE")
...
m_zone_text:SetFont(C["media"].pfont, 8, "MONOCHROMEOUTLINE")
...
m_coord_text:SetFont(C["media"].pfont, 8, "MONOCHROMEOUTLINE")
