...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(C.media.pfont, 12, "MONOCHROMEOUTLINE")
...
local function CreateRollFrame()
	...
	status:SetStatusBarTexture(C["media"].blank)
	...
	bind:SetFont(C.media.pfont, 12, "MONOCHROMEOUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(C.media.pfont, 12, "MONOCHROMEOUTLINE")
...
label:SetFont(C.media.pfont, 12, "MONOCHROMEOUTLINE")
...
anchor:SetScript("OnEvent", function(frame, event, addon)
	...
	anchor:Point("CENTER", UIParent, "CENTER", 0, -30)
end)
