...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(C["media"].pfont, 8, "MONOCHROMEOUTLINE")
...
local function CreateRollFrame()
	...
	bind:SetFont(C["media"].pfont, 8, "MONOCHROMEOUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(C["media"].pfont, 8, "MONOCHROMEOUTLINE")
...
label:SetFont(C["media"].pfont, 8, "MONOCHROMEOUTLINE")
