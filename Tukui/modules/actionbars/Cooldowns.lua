...
local FONT_FACE = C["media"].pfont --what font to use
local FONT_SIZE = 14 --the base font size to use at a scale of 1
...
local function Timer_OnSizeChanged(self, width, height)
	...
	if fontScale < MIN_SCALE then
		...
		self.text:SetFont(FONT_FACE, fontScale * FONT_SIZE, 'MONOCHROMEOUTLINE')
