...
Text1:SetFont(C.media.pfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE")
...
Text2:SetFont(C.media.pfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE")
...
Text3:SetFont(C.media.pfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE")
