...
local TukuiThreatBar = CreateFrame("StatusBar", "TukuiThreatBar", TukuiTarget)
TukuiThreatBar:Size(5, TukuiTarget:GetHeight() - 8)
TukuiThreatBar:Point("LEFT", TukuiTarget, "RIGHT", 7, 4)
TukuiThreatBar:CreateBorder(false, true)
TukuiThreatBar:SetOrientation("Vertical")

local threatBG = CreateFrame("Frame", nil, TukuiThreatBar)
threatBG:CreatePanel("Transparent", TukuiThreatBar:GetWidth(), TukuiThreatBar:GetHeight(), "TOPLEFT", TukuiThreatBar, "TOPLEFT", -2, 2)
threatBG:Point("BOTTOMRIGHT", TukuiThreatBar, "BOTTOMRIGHT", 2, -2)
