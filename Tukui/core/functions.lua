...
T.PP = function(p, obj)
	...
	if p == 1 then
		obj:SetParent(left)
		obj:SetHeight(20)
		obj:SetPoint("BOTTOMLEFT", left, "BOTTOMLEFT", 30, 0)
	elseif p == 2 then
		obj:SetParent(left)
		obj:SetHeight(20)
		obj:SetPoint("BOTTOM", left, "BOTTOM")
	elseif p == 3 then
		obj:SetParent(left)
		obj:SetHeight(20)
		obj:SetPoint("BOTTOMRIGHT", left, "BOTTOMRIGHT", -30, 0)
	elseif p == 4 then
		obj:SetParent(right)
		obj:SetHeight(20)
		obj:SetPoint("BOTTOMLEFT", right, "BOTTOMLEFT", 30, 0)
	elseif p == 5 then
		obj:SetParent(right)
		obj:SetHeight(20)
		obj:SetPoint("BOTTOM", right, "BOTTOM")
	elseif p == 6 then
		obj:SetParent(right)
		obj:SetHeight(20)
		obj:SetPoint("BOTTOMRIGHT", right, "BOTTOMRIGHT", -30, 0)
	end
end
...
T.PostNamePosition = function(self)
	...
	if (self.Power.value:GetText() and UnitIsEnemy("player", "target") and C["unitframes"].targetpowerpvponly == true) or (self.Power.value:GetText() and C["unitframes"].targetpowerpvponly == false) then
		...
		self.Name:SetPoint("LEFT", self.panel, "LEFT", 6, 0)
	end
end
